...
public class UserRate extends Command {
	private static final long serialVersionUID = 2423353715955164399L;

	private static final Logger LOG = Logger.getLogger(UserRate.class);
	@Override
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		Collections.sort(tariff, new MyCmp());
     ...
     private class MyCmp implements Comparator<Tariff>,Serializable{
